...
def get_source_cat(image, imageref='', params=[], conf_file=None, conf_args={}, keepcat=True, rerun=False, catdir=None):
    """
    ...
    HDUFile = pysex.run(image, imageref=imageref, params=params, conf_file=conf_file, conf_args=conf_args, keepcat=keepcat, rerun=rerun, catdir=catdir)
